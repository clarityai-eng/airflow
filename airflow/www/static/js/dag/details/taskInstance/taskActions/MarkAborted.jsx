...
import { useConfirmMarkTask, useMarkAbortedTask } from '../../../../api';
...
const MarkAborted = ({
  ...
  const { mutateAsync: markAbortedMutation, isLoading: isMarkLoading } = useMarkAbortedTask({
    dagId, runId, taskId,
  });
  const {
    mutateAsync: confirmChangeMutation, isLoading: isConfirmLoading,
  } = useConfirmMarkTask({
    dagId, runId, taskId, state: 'aborted',
  });
  ...
  return (
    <Flex justifyContent="space-between" width="100%">
      ...
      <ConfirmDialog
        ...
        onConfirm={onConfirm}
        isLoading={isLoading}
        description="Task instances you are about to mark as aborted:"
        body={affectedTasks}
      />
    </Flex>
  );
